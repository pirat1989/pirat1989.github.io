...
(function ($) {
	...
	var default_options  = {
		i18n: {
			ar: { // Arabic
				months: [
					"ЩѓШ§Щ†Щ€Щ† Ш§Щ„Ш«Ш§Щ†ЩЉ", "ШґШЁШ§Ш·", "ШўШ°Ш§Ш±", "Щ†ЩЉШіШ§Щ†", "Щ…Ш§ЩЉЩ€", "Ш­ШІЩЉШ±Ш§Щ†", "ШЄЩ…Щ€ШІ", "ШўШЁ", "ШЈЩЉЩ„Щ€Щ„", "ШЄШґШ±ЩЉЩ† Ш§Щ„ШЈЩ€Щ„", "ШЄШґШ±ЩЉЩ† Ш§Щ„Ш«Ш§Щ†ЩЉ", "ЩѓШ§Щ†Щ€Щ† Ш§Щ„ШЈЩ€Щ„"
				],
				dayOfWeek: [
					"Щ†", "Ш«", "Ш№", "Ш®", "Ш¬", "Ші", "Ш­"
				]
			...
			is: { // Icelandic
				months: [
					"JanГєar", "FebrГєar", "Mars", "AprГ­l", "MaГ­", "JГєnГ­", "JГєlГ­", "ГЃgГєst", "September", "OktГіber", "NГіvember", "Desember"
				],
				dayOfWeek: [
					"Sun", "MГЎn", "ГћriГ°", "MiГ°", "Fim", "FГ¶s", "Lau"
				]
			},
			bg: { // Bulgarian
				months: [
			...
			uk: { // Ukrainian
				...
				dayOfWeek: [
					"РќРґР»", "РџРЅРґ", "Р’С‚СЂ", "РЎСЂРґ", "Р§С‚РІ", "РџС‚РЅ", "РЎР±С‚"
				]
			},
			en: { // English
				months: [
			...
			et: { //"Eesti"
				months: [
					"Jaanuar", "Veebruar", "MГ¤rts", "Aprill", "Mai", "Juuni", "Juuli", "August", "September", "Oktoober", "November", "Detsember"
				],
				dayOfWeek: [
					"P", "E", "T", "K", "N", "R", "L"
				]
			...
			eu: { //Euskara
				...
				months: [
					"Tammikuu", "Helmikuu", "Maaliskuu", "Huhtikuu", "Toukokuu", "KesГ¤kuu", "HeinГ¤kuu", "Elokuu", "Syyskuu", "Lokakuu", "Marraskuu", "Joulukuu"
				],
				dayOfWeek: [
			...
			lt: { //Lithuanian (lietuviЕі)
				months: [
					"Sausio", "Vasario", "Kovo", "BalandЕѕio", "GeguЕѕД—s", "BirЕѕelio", "Liepos", "RugpjЕ«ДЌio", "RugsД—jo", "Spalio", "LapkriДЌio", "GruodЕѕio"
				],
				dayOfWeek: [
					"Sek", "Pir", "Ant", "Tre", "Ket", "Pen", "Е eЕЎ"
				]
			},
			lv: { //Latvian (LatvieЕЎu)
				months: [
					"JanvДЃris", "FebruДЃris", "Marts", "AprД«lis ", "Maijs", "JЕ«nijs", "JЕ«lijs", "Augusts", "Septembris", "Oktobris", "Novembris", "Decembris"
				],
				dayOfWeek: [
					"Sv", "Pr", "Ot", "Tr", "Ct", "Pk", "St"
				]
			},
			mk: { //Macedonian (РњР°РєРµРґРѕРЅСЃРєРё)
				months: [
					"СР°РЅСѓР°СЂРё", "С„РµРІСЂСѓР°СЂРё", "РјР°СЂС‚", "Р°РїСЂРёР»", "РјР°С", "ССѓРЅРё", "ССѓР»Рё", "Р°РІРіСѓСЃС‚", "СЃРµРїС‚РµРјРІСЂРё", "РѕРєС‚РѕРјРІСЂРё", "РЅРѕРµРјРІСЂРё", "РґРµРєРµРјРІСЂРё"
				],
				dayOfWeek: [
					"РЅРµРґ", "РїРѕРЅ", "РІС‚Рѕ", "СЃСЂРµ", "С‡РµС‚", "РїРµС‚", "СЃР°Р±"
				]
			},
			mn: { //Mongolian (РњРѕРЅРіРѕР»)
				months: [
					"1-СЂ СЃР°СЂ", "2-СЂ СЃР°СЂ", "3-СЂ СЃР°СЂ", "4-СЂ СЃР°СЂ", "5-СЂ СЃР°СЂ", "6-СЂ СЃР°СЂ", "7-СЂ СЃР°СЂ", "8-СЂ СЃР°СЂ", "9-СЂ СЃР°СЂ", "10-СЂ СЃР°СЂ", "11-СЂ СЃР°СЂ", "12-СЂ СЃР°СЂ"
				],
				dayOfWeek: [
					"Р”Р°РІ", "РњСЏРі", "Р›С…Р°", "РџТЇСЂ", "Р‘СЃРЅ", "Р‘СЏРј", "РќСЏРј"
				]
			},
			...
			'sr-YU': { //Serbian (Srpski)
				...
				dayOfWeek: [
					"Ned", "Pon", "Uto", "Sre", "ДЌet", "Pet", "Sub"
				]
			},
			sr: { //Serbian Cyrillic (РЎСЂРїСЃРєРё)
				months: [
					"СР°РЅСѓР°СЂ", "С„РµР±СЂСѓР°СЂ", "РјР°СЂС‚", "Р°РїСЂРёР»", "РјР°С", "ССѓРЅ", "ССѓР»", "Р°РІРіСѓСЃС‚", "СЃРµРїС‚РµРјР±Р°СЂ", "РѕРєС‚РѕР±Р°СЂ", "РЅРѕРІРµРјР±Р°СЂ", "РґРµС†РµРјР±Р°СЂ"
				],
				dayOfWeek: [
					"РЅРµРґ", "РїРѕРЅ", "СѓС‚Рѕ", "СЃСЂРµ", "С‡РµС‚", "РїРµС‚", "СЃСѓР±"
				]
			},
			sv: { //Svenska
				months: [
			...
			'zh-TW': { //Traditional Chinese (з№Ѓй«”дё­ж–‡)
				months: [
					"дёЂжњ€", "дєЊжњ€", "дё‰жњ€", "е››жњ€", "дє”жњ€", "е…­жњ€", "дёѓжњ€", "е…«жњ€", "д№ќжњ€", "еЌЃжњ€", "еЌЃдёЂжњ€", "еЌЃдєЊжњ€"
				],
				dayOfWeek: [
			...
			zh: { //Simplified Chinese (з®ЂдЅ“дё­ж–‡)
				months: [
					"дёЂжњ€", "дєЊжњ€", "дё‰жњ€", "е››жњ€", "дє”жњ€", "е…­жњ€", "дёѓжњ€", "е…«жњ€", "д№ќжњ€", "еЌЃжњ€", "еЌЃдёЂжњ€", "еЌЃдєЊжњ€"
				],
				dayOfWeek: [
			...
			hy: { // Armenian
				months: [
					"ХЂХёЦ‚Х¶ХѕХЎЦЂ", "Х“ХҐХїЦЂХѕХЎЦЂ", "Х„ХЎЦЂХї", "Ф±ХєЦЂХ«Х¬", "Х„ХЎХµХ«ХЅ", "ХЂХёЦ‚Х¶Х«ХЅ", "ХЂХёЦ‚Х¬Х«ХЅ", "Х•ХЈХёХЅХїХёХЅ", "ХЌХҐХєХїХҐХґХўХҐЦЂ", "ХЂХёХЇХїХҐХґХўХҐЦЂ", "Х†ХёХµХҐХґХўХҐЦЂ", "ФґХҐХЇХїХҐХґХўХҐЦЂ"
				],
				dayOfWeek: [
					"ФїХ«", "ФµЦЂХЇ", "ФµЦЂЦ„", "Х‰ХёЦЂ", "ХЂХ¶ХЈ", "Х€Ц‚ЦЂХў", "Х‡ХўХ©"
				]
			},
            kg: { // Kyrgyz
                months: [
                    'Т®С‡С‚ТЇРЅ Р°Р№С‹', 'Р‘РёСЂРґРёРЅ Р°Р№С‹', 'Р–Р°Р»РіР°РЅ РљСѓСЂР°РЅ', 'Р§С‹РЅ РљСѓСЂР°РЅ', 'Р‘СѓРіСѓ', 'РљСѓР»Р¶Р°', 'РўРµРєРµ', 'Р‘Р°С€ РћРѕРЅР°', 'РђСЏРє РћРѕРЅР°', 'РўРѕРіСѓР·РґСѓРЅ Р°Р№С‹', 'Р–РµС‚РёРЅРёРЅ Р°Р№С‹', 'Р‘РµС€С‚РёРЅ Р°Р№С‹'
                ],
                dayOfWeek: [
                    "Р–РµРє", "Р”ТЇР№", "РЁРµР№", "РЁР°СЂ", "Р‘РµР№", "Р–СѓРј", "РС€Рµ"
                ]
            }
		},
		value: '',
